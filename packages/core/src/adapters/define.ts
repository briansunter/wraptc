...
import type { AdapterConfig, AdapterHooks, AdapterDefinition } from "./types";
...
export function defineAdapter(
	config: AdapterConfig & Partial<AdapterHooks>,
): AdapterDefinition {
 ...
 */
export type ValidAdapterDefinition = Required<
	Pick<AdapterDefinition, "id" | "binary">
> &
